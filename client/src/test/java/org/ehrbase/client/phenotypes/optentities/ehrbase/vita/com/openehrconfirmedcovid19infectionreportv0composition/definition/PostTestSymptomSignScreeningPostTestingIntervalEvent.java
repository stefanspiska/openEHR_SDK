...
public class PostTestSymptomSignScreeningPostTestingIntervalEvent implements PostTestSymptomSignScreeningPostTestingChoice {
  @Path("/time|value")
  ...
  private List<PostTestSymptomSignScreeningSpecificSymptomSignCluster> specificSymptomSign;
  ...
  public void setSpecificSymptomSign(
      List<PostTestSymptomSignScreeningSpecificSymptomSignCluster> specificSymptomSign) {
     this.specificSymptomSign = specificSymptomSign;
  }

  public List<PostTestSymptomSignScreeningSpecificSymptomSignCluster> getSpecificSymptomSign() {
